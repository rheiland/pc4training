...
class UserTab(object):
    ...
    def __init__(self):
        ...
        param_name2 = Button(description='cargo_signal_D', disabled=True, layout=name_button_layout)
        ...
        param_name3 = Button(description='cargo_signal_decay', disabled=True, layout=name_button_layout)
        ...
        param_name4 = Button(description='director_signal_D', disabled=True, layout=name_button_layout)
        ...
        param_name5 = Button(description='director_signal_decay', disabled=True, layout=name_button_layout)
        ...
        param_name6 = Button(description='elastic_coefficient', disabled=True, layout=name_button_layout)
        ...
        param_name7 = Button(description='worker_motility_persistence_time', disabled=True, layout=name_button_layout)
        ...
        param_name8 = Button(description='worker_migration_speed', disabled=True, layout=name_button_layout)
        ...
        param_name9 = Button(description='attached_worker_migration_bias', disabled=True, layout=name_button_layout)
        ...
        param_name10 = Button(description='unattached_worker_migration_bias', disabled=True, layout=name_button_layout)
        ...
        param_name11 = Button(description='number_of_directors', disabled=True, layout=name_button_layout)
        ...
        param_name12 = Button(description='number_of_cargo_clusters', disabled=True, layout=name_button_layout)
        ...
        param_name13 = Button(description='number_of_workers', disabled=True, layout=name_button_layout)
        ...
        param_name14 = Button(description='drop_threshold', disabled=True, layout=name_button_layout)
        ...
        param_name15 = Button(description='worker_color', disabled=True, layout=name_button_layout)
        ...
        param_name16 = Button(description='cargo_color', disabled=True, layout=name_button_layout)
        ...
        param_name17 = Button(description='director_color', disabled=True, layout=name_button_layout)
        ...
        units_button2 = Button(description='micron/min^2', disabled=True, layout=units_button_layout) 
        units_button2.style.button_color = 'tan'
        units_button3 = Button(description='1/min', disabled=True, layout=units_button_layout) 
        units_button3.style.button_color = 'lightgreen'
        units_button4 = Button(description='micron/min^2', disabled=True, layout=units_button_layout) 
        ...
        row3 = [param_name3, self.cargo_signal_decay, units_button3, desc_button3] 
        row4 = [param_name4, self.director_signal_D, units_button4, desc_button4] 
        row5 = [param_name5, self.director_signal_decay, units_button5, desc_button5] 
        row6 = [param_name6, self.elastic_coefficient, units_button6, desc_button6] 
        row7 = [param_name7, self.worker_motility_persistence_time, units_button7, desc_button7] 
        row8 = [param_name8, self.worker_migration_speed, units_button8, desc_button8] 
        row9 = [param_name9, self.attached_worker_migration_bias, units_button9, desc_button9] 
        row10 = [param_name10, self.unattached_worker_migration_bias, units_button10, desc_button10] 
        row11 = [param_name11, self.number_of_directors, units_button11, desc_button11] 
        row12 = [param_name12, self.number_of_cargo_clusters, units_button12, desc_button12] 
        row13 = [param_name13, self.number_of_workers, units_button13, desc_button13] 
        row14 = [param_name14, self.drop_threshold, units_button14, desc_button14] 
        row15 = [param_name15, self.worker_color, units_button15, desc_button15] 
        row16 = [param_name16, self.cargo_color, units_button16, desc_button16] 
        row17 = [param_name17, self.director_color, units_button17, desc_button17] 
